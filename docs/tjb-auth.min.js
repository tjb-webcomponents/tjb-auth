...
////////////////////////////////////////////////////////////
error(area,message){return this[`${area}Node`].error(message)}success(area,message){return this[`${area}Node`].success(message)}}customElements.define("tjb-auth",tjbAuth);
